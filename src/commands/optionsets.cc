...
std::vector<ZyppFlags::CommandGroup> OptionalPatchesOptionSet::options()
{
  ...
  return {{
      {
        {"with-optional", '\0', ZyppFlags::NoArgument, ZyppFlags::BoolType( reinterpret_cast<bool *>( &gOpts.exclude_optional_patches ), ZyppFlags::StoreFalse ), "" },
        {"without-optional", '\0', ZyppFlags::NoArgument, ZyppFlags::BoolType( reinterpret_cast<bool *>( &gOpts.exclude_optional_patches ), ZyppFlags::StoreTrue ),
